	...
	return (
		<section id="#experience" className="snap-center">
			<motion.div
				...
				className="h-screen flex flex-col relative text-center md:text-left mx-auto max-w-7xl px-10 justify-start items-center"
			>
				<h3 className="relative top-20 text-2xl uppercase tracking-[12px] text-gray-400/80">
					Experience
				</h3>

				<div className="relative top-24 flex justify-start items-center w-full max-w-full overflow-x-auto">
					<ExperienceCard
